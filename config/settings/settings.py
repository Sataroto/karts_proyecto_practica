"""
Django settings for go_kart_zone project.
...
SECRET_KEY = 'django-insecure-9skjxo6nfn%5(wm=8n(71vm@%mus=tml*et)i(w3%u%j_v*(8d'
...
STATICFILES_DIRS = [
    BASE_DIR / 'go_kart_zone/static',
]

MEDIA_URL = 'media/'

MEDIA_ROOT = BASE_DIR / 'go_kart_zone/media'
